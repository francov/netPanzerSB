...
function loadInfo() {
    ...
    $.getJSON("http://www.netpanzer.info/public/serverbrowser.json.php", function(data) {
        ...
        $.each(data, function (i, gameserver) {
            ...
            // Load details and appent to pageContainer
            $.mobile.pageContainer.loadTemplate($("#gameserverDetails-tpl"), {
                pageid: "serverDetails"+i,
